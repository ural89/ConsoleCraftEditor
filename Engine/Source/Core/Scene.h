...
public:
	GameObject* CreateGameObjectFromTemplate(std::string gameObjectName);
...
private:
	void AttachParentsFromSceneData(SceneData &sceneData, std::vector<GameObject *> &createdGameObjects);
